...
especially with developer tools turned on. Ask Ayman if you need help getting access 
...
- [nano text editor](https://www.nano-editor.org/) (comes with GitBash and default on MacOS)
